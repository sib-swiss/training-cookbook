...
With this summary, the group members (Coordinators and Trainers) meet to evaluate whether the previous year's courses met the community's training needs and to determine if any changes in topics or frequency are necessary.
...
Multiple discussions among group members and trainers are necessary to finalize the courses, their frequency, and the Trainers for the upcoming year. This draft plan is organized into a Gantt chart. Once stable, Coordinators proceed to organize the course plan.
...
It is  also taken into account the [Call for new courses](call_new_courses.md), and which topics were accepted.
...
Having the program ready in advance allows stakeholders (Trainers, Coordinators, Participants) to plan accordingly and enhances SIB Training's visibility and recognition.
...
The Gantt chart is refined through iterations with Trainers and Coordinators. Once finalized, Admin transfers the details to the Working spreadsheet of the Year. The Training Group Leader assigns a Coordinator per course to start the organization.

Each Coordinator enters the course description in courseadmin, making the upcoming year's courses visible on the [Upcoming training courses page](https://www.sib.swiss/training/upcoming-training-courses).
