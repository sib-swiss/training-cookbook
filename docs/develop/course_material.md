...
Depending on the agreement it can be developed by the Trainer or by the Coordinator.  

The page can be shared in the course description ([Finalize course description](../design/course_description.md)) and/or in the email with information to the participants ([Send practical information to registered students](../deliver/course_instance_coordination/send_info.md))  
...
The Trainer uploads the course material to a repository like Zenodo, for example [see link](https://zenodo.org/communities/sib-training/?page=1&size=20) Under the title [Course material](course_material.md).  
