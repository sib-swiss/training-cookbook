1. Coordinator change the status “Applied” to “Waiting list”. 
...
2. Coordinator (possibly also Admin) updates the courseadmin with absences or very late cancellations and tag them as “Absent”. 
...
3. Coordinator (possibly also Admin) updates the courseadmin by indicating the participants who have successfully passed the exam and thus are eligible to receive a ”Certificate of Achievement”. 
...
4. Coordinator informs Admin when this process is done, meaning Admin can: 
