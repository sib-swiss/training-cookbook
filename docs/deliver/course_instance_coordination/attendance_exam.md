...
Within the 2 weeks following the end of a course, see [ECTS credits and Exam](../../evaluate/ECTS_exam.md) for the rules on exams, the Trainer sends the results of the exams to the Manager and Admin, who will then update the courseadmin with pass or fail.  
